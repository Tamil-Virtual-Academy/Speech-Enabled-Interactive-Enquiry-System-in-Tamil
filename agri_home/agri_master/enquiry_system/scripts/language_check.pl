...
foreach $txt(@text)
{
	...
	if(@first_char[0] =~ /^[a-zA-Z]+$/)
	{
		...
		print lang "eng";
		close(lang);
		copy("festvox/ssn_english_oald_lexicon.scm","festvox/ssn_hts_demo_lexicon.scm");
		...
		`/home/jjoysingh/speech/festival/bin/festival -b festvox/build_clunits.scm '(build_prompts "etc/bi_txt")'`;
		copy("festvox/ssn_tamil_male_clunits.scm","festvox/ssn_hts_demo_clunits.scm");
		copy("festvox/ssn_tamil_female_lexicon.scm","festvox/ssn_hts_demo_lexicon.scm");
